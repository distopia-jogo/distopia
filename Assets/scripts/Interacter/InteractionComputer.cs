...
public class InteractionComputer : MonoBehaviour
{
    public SpriteRenderer imageComputer;
    ...
    private void OnTriggerEnter2D(Collider2D collision){
        _mayExecute=true;
        imageComputer.color = new Color(255f/255f, 183f/255f, 0f/255f);
    }

    private void OnTriggerExit2D(Collider2D collision){
        _mayExecute=false;
        imageComputer.color = Color.white;
    }
}
